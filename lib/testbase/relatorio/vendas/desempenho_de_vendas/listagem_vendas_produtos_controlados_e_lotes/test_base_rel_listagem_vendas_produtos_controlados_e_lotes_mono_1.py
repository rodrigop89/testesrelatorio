...
# Filtro todos os produtos, todas listas sngpc, somente vendas sem lotes
# e ordenado por data
@mark.emitir_rel_listagem_produtos_controlados_e_lotes_mono
def test_rel_list_prod_controlados_sem_lotes_todas_as_vendas_data_mono():
...
@mark.emitir_rel_listagem_produtos_controlados_e_lotes_mono
def test_rel_list_prod_controlados_lotes_todos_prod_vendas_sem_lote_receituario_data_mono():
...
@mark.emitir_rel_listagem_produtos_controlados_e_lotes_mono
def test_rel_list_prod_controlados_lotes_todos_prod_vendas_sem_lote_sem_receituario_data_mono():
...
# e ordenado por produto
@mark.emitir_rel_listagem_produtos_controlados_e_lotes_mono
def test_rel_list_prod_controlados_sem_lotes_todas_as_vendas_produto_mono():
    """Filtro todos os produtos, somente vendas sem lote, com e sem receituário"""
    login_sistema()
    digitar_nome_relatorio(COD_10)
    esperar_tempo(TEMPO_ESPERA)
...
@mark.emitir_rel_listagem_produtos_controlados_e_lotes_mono
def test_rel_list_prod_controlados_lotes_todos_prod_vendas_sem_lote_receituario_produto_mono():
    """Filtro todos os produtos, somente vendas sem lote e com receituário"""
    login_sistema()
    digitar_nome_relatorio(COD_10)
    esperar_tempo(TEMPO_ESPERA)
...
@mark.emitir_rel_listagem_produtos_controlados_e_lotes_mono
def test_rel_list_prod_controlados_lotes_todos_prod_vendas_sem_lote_sem_receituario_produto_mono():
    """Filtro todos os produtos, somente vendas sem lote e sem receituário"""
    login_sistema()
    digitar_nome_relatorio(COD_10)
    esperar_tempo(TEMPO_ESPERA)
